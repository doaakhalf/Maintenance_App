...
class CalibrationPerformStatusChangedNotify extends Notification implements ShouldQueue
{
    use Queueable;
    protected $calibrationPerform;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'perform_date' => $this->calibrationPerform->request_date,
            'calibration_request_id' => $this->calibrationPerform->calibration_request_id,
            'title' =>'Status Of Calibration Perform Number '. $this->calibrationPerform->id. 'is changed to '.$this->calibrationPerform->status,
