...
<div class="form-row">
    ...
    <div class="form-group col-md-4">
        ...
        <div class="form-check">
            <input class="form-check-input" id="flexRadioDefault1" type="radio" value="Inner" name="type" id="type1" {{ isset($maintenance_request)? ( old('type',$maintenance_request->type) == "Inner" ? 'checked' : ''):"" }}>
        ...
        <div class="form-check">
            <input class="form-check-input" id="flexRadioDefault2" type="radio" value="Outer" name="type" id="type2" {{isset($maintenance_request)? ( old('type',$maintenance_request->type) == "Outer" ? 'checked' : ''):"" }}>
            <label class="form-check-label" for="flexRadioDefault2">
                Outer
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input" id="flexRadioDefault3" type="radio" value="Warranty" name="type" id="type3" {{isset($maintenance_request)? ( old('type',$maintenance_request->type) == "Warranty" ? 'checked' : ''):"" }}>
