...
@section('title', 'Create Calibration Perform')

@section('content_header')
<h1>Create Calibration Perform
    <span> @can('forward', $calibration_request)
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('admin.calibration-perform.store',$calibration_request->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label for="equipment_name">Equipment Serial Number (sn) </label>
                    <input disabled type="text" id="equipment_sn" name="equipment_sn" class="form-control" value="{{ old('equipment_name', $calibration_request->equipment->sn ?? '') }}">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="technician_id" id="technician_id" class="form-control" value="{{ old('technician_id',$calibration_request->signed_to_id) }}">
            </div>
            ...
            {{-- Calibration Perform Detail - Spare Parts --}}
