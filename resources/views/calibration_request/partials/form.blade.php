...
<div class="form-group col-md-4">
        <label for="equipment_name">Calibration Request  Name  <span class="text-danger">*</span></label>
        <input required  type="text" id="name" name="name" value="{{ old('name', $calibration_request->name ?? '') }}" class="form-control" >
        @if($errors->has('name'))
    ...
    <div class="form-group col-md-4">
        ...
        <div class="form-control">
            ...
            @foreach ($equipment as $equipment_record)
                <option value="{{ $equipment_record->id }}" {{ (old('equipment_id', $calibration_request->equipment_id ?? '') == $equipment_record->id) ? 'selected' : '' }}>{{ $equipment_record->sn }}</option>
                @endforeach
            </select>
    ...
    <div class="form-group col-md-4">
        ...
        <input disabled type="text" id="equipment_name" name="equipment_name"  class="form-control" value="{{ old('equipment_name', $calibration_request->equipment->name ?? '') }}" >
 
    </div>
    <div class="form-group col-md-4">
        <label for="equipment_model">Equipment Model  </label>
        <input disabled type="text" id="equipment_model" name="equipment_model" class="form-control" value="{{ old('equipment_model', $calibration_request->equipment->model ?? '') }}" >
  
    </div>
    <div class="form-group col-md-4">
        <label for="department_number">Department Number </label>
        <input disabled type="text" id="department_number" name="department_number" class="form-control" value="{{ old('department_number', $calibration_request->equipment->department->number ?? '') }}" >
  
    </div>
    <div class="form-group col-md-4">
        <label for="department_number">Department Name </label>
        <input disabled type="text" id="department_name" name="department_name" class="form-control" value="{{ old('department_name', $calibration_request->equipment->department->name ?? '') }}" >
  
    </div>
    <div class="form-group col-md-12">
        <label for="department_location">Department Location </label>
        <input disabled type="text" id="department_location" name="department_location" class="form-control" value="{{ old('department_location',$calibration_request->equipment->department->location ?? '') }}" >
...
<div class="form-group col-md-8">
        <label for="signed_to_id">Sign to <span class="text-danger">*</span></label>
            ...
            <select name="signed_to_id" id="signed_to_id" class="form-control" required>
                ...
                @foreach($users as $user)
                    <option value="{{ $user->id }}" {{isset($calibration_request)? ( old('signed_to_id',$calibration_request->signed_to_id) == $user->id ? 'selected' : ''):"" }}>
                        {{ $user->email }}
                    </option>
                @endforeach
            </select>
    ...
    <label for="signed_to_id">Type <span class="text-danger">*</span></label>
        ...
        <input class="form-check-input" type="radio" value="Inner" name="type" id="type1" {{ isset($calibration_request)? ( old('type',$calibration_request->type) == "Inner" ? 'checked' : ''):"" }}>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio"  value="Outer" name="type" id="type2"  {{isset($calibration_request)? ( old('type',$calibration_request->type) == "Outer" ? 'checked' : ''):"" }} >
            <label class="form-check-label" for="flexRadioDefault2">
                Outer
            </label>
        </div>
        <div class="form-check">
            <input class="form-check-input"  type="radio" value="Warranty" name="type" id="type3" {{isset($calibration_request)? ( old('type',$calibration_request->type) == "Warranty" ? 'checked' : ''):"" }} >
            <label class="form-check-label" for="flexRadioDefault2">
                Warranty
            </label>
        </div>
